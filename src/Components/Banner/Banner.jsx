...
const Banner = ({ handleSearch}) => {
    ...
    return (
        <div className="h-[45vh] bg-no-repeat bg-cover bg-center lg:h-[70vh]" style={{ backgroundImage: `url(${bannerImg})` }}>
            <div className="hero-overlay bg-opacity-90 bg-slate-50">
                <Header></Header>
                <div className="flex flex-col px-10 mt-16 text-center justify-center items-center lg:p-0">
                    <div>
                        <h2 className="text-3xl font-extrabold font-mono">I Grow By Helping People In Need</h2>
